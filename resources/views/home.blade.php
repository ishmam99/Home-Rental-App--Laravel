      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Welcome  Mr {{Auth::user()->name}} <br><h3> Your Rentals and Properties</h3></h1>
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    <li>
                      ...
                      <p class="card-info-title">{{$item->description}}</p>
  ...
  <section class="intro-single">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single"> Your Booked Properties</h1>
            <span class="color-text-a">Grid Properties</span>
          </div>
        </div>
