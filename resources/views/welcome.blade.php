...
@section('content')
 <div class="intro intro-carousel">
    <div id="carousel" class="owl-carousel owl-theme">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url({{asset($item->image_one)}})">
                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <h1 class="intro-title mb-4">
                     <a href="{{route('rents.show',['id'=>$item->id])}}">Click Here for Details</a>
                     </h1>
        ...
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            ...
            <div class="title-link">
              <a href="{{route('rents')}}">All Property
              ...
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">{{$item->location}}
                  </h2>
                </div>
                <div class="card-body-a">
                  ...
                  <a href="{{route('rents.show',['id'=>$item->id])}}">Click Here for Details
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                </div>
